...
INSERT INTO "new_orders" ("address_json", "business_date", "created_at", "customer_note", "delivered_at", "delivery_fee_paise", "edit_count", "editable_until", "handling_fee_paise", "id", "order_number", "otp_hash", "outlet_id", "payment_method", "payment_status", "placed_at", "prep_seconds", "promised_at", "status", "subtotal_paise", "tax_paise", "total_paise", "updated_at", "user_id", "version") SELECT "address_json", "business_date", "created_at", "customer_note", "delivered_at", "delivery_fee_paise", "edit_count", "editable_until", "handling_fee_paise", "id", "order_number", "otp_hash", "outlet_id", "payment_method", "payment_status", "placed_at", "prep_seconds", "promised_at", "status", "subtotal_paise", "tax_paise", "total_paise", "updated_at", "user_id", "version" FROM "orders";
DROP TABLE "orders";
